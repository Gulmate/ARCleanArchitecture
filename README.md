...
+ Entities: Ide kerülnek azok az elemek, amelyek a legkevesebbszer változnak. (Core mappa)
...
A projekt a Dependency Injection-hőz [VContainert](https://github.com/hadashiA/VContainer) használ. 
