public class DTOMessageWrapperUsecase
{
    public string ConvertToMessage(DTOMessageWrapper dTOMessage)
    {
    ...
    public DTOMessageWrapper ConvertFromMessage(string message)
    {
    ...
    public bool IsNotBasicWebSocketMessageType(int type) => type > 100;
}